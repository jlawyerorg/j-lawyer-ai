...
public class ApiClient {
    ...
    private String basePath = "http://localhost/j-lawyer-io/rest";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/7/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/j-lawyer-io/rest
